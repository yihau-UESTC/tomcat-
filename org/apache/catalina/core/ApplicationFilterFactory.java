...
public final class ApplicationFilterFactory {
    ...
    public static ApplicationFilterChain createFilterChain(ServletRequest request,
        ...
        // Create and initialize a filter chain object创建、初始化过滤器链
        ...
        filterChain.setServlet(servlet);//绑定servlet
        filterChain.setServletSupportsAsync(wrapper.isAsyncSupported());

        // Acquire the filter mappings for this Context获取当前web的过滤器映射
        ...
        // Add the relevant path-mapped filters to this filter chain添加匹配的过滤器到链中
