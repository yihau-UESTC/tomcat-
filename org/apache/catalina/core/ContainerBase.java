...
public abstract class ContainerBase extends LifecycleMBeanBase
    ...
    protected synchronized void startInternal() throws LifecycleException {
        ...
        // Start our child containers, if any 将子容器的启动包装为一个Callable类型，放入线程池异步启动。
        ...
        setState(LifecycleState.STARTING);//设置组件的状态，并触发相应的事件

        // Start our thread，开启后台检测session超时的线程
        threadStart();
    }
